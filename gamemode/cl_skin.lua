...
function SKIN:PaintScoreboardEntry(panel, w, h)
	...
	if title and #title > 0 then
		...
		draw.SimpleText(title, "CombineControl.LabelTiny", h + ui.Scale(19), math.Round(h * 0.7), color, TEXT_ALIGN_LEFT)
	else
		...
		draw.SimpleText(string.Unescape(ply:ShortDescription()), "CombineControl.LabelSmall", h + ui.Scale(19), math.Round(h * 0.66), self.Text.Disabled, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end
