...
SCOREBOARD_SHOW   = 1 -- Normal display on the scoreboard
SCOREBOARD_HIDDEN = 2 -- Red background on the scoreboard
SCOREBOARD_SKIP   = 3 -- Skip display on the scoreboard
