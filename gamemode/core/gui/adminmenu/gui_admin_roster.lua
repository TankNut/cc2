...
function PANEL:Init()
	...
	self.List:AddColumn("Usergroup"):SetFixedWidth(ui.Scale(70))
	self.List:AddColumn("SteamID"):SetFixedWidth(ui.Scale(150))
	self.List:AddColumn("Alias")
	self.List:AddColumn("Steam Name")
	self.List:AddColumn("Last Seen"):SetFixedWidth(ui.Scale(100))
	...
	if lp:IsSuperAdmin() then
		...
		self.AddUser:SetSize(ui.Scale(100), ui.Scale(20))
		...
		self.UpdateAlias:SetSize(ui.Scale(100), ui.Scale(20))
		...
		self.DemoteUser:SetSize(ui.Scale(100), ui.Scale(20))
