local setCharacterModel = console.AddCommand("rpa_setcharmodel", function (ply, target, mdl)
	...
	console.Feedback(ply, "WARNING", "You've set %s's character model to \"%s\"", target, mdl)
	console.Feedback(target, "WARNING", "%s has set your character model to \"%s\"", ply, mdl)
end)
...
local setCharacterSkin = console.AddCommand("rpa_setcharskin", function (ply, target, skin)
	...
	console.Feedback(ply, "WARNING", "You've set %s's character skin to \"%d\"", target, skin)
	console.Feedback(target, "WARNING", "%s has set your character skin to \"%d\"", ply, skin)
end)
...
local setCharacterName = console.AddCommand("rpa_setcharname", function (ply, target, name)
	...
	console.Feedback(ply, "WARNING", "You've set %s's character name to \"%s\"", target, name)
	console.Feedback(target, "WARNING", "%s has set your character name to \"%s\"", ply, name)
end)
