-- All of the soundscripts that are baked into model files, please don't use them for anything else
sound.Add({
...
sound.Add({
	...
	pitch = {97.5, 102.5},
	sound = {
		"vuthakral/halo/weapons/needlerifle/ready0.wav",
...
sound.Add({
	...
	pitch = {97.5, 102.5},
	sound = {
		"vuthakral/halo/weapons/needlerifle/reload0.wav",
...
sound.Add({
	...
	pitch = 100,
	sound = {
		"vuthakral/halo/weapons/needlerifle/pose1-0.wav",
...
sound.Add({
	...
	pitch = 100,
	sound = {
		"vuthakral/halo/weapons/needlerifle/pose2-0.wav",
