...
holdTypes.shotgun[ACT_MP_JUMP] = ACT_HL2MP_JUMP_AR2

holdTypes.heavy = table.Copy(holdTypes.crossbow)
holdTypes.heavy[ACT_MP_CROUCH_IDLE] = ACT_HL2MP_IDLE_CROUCH_PHYSGUN
holdTypes.heavy[ACT_MP_ATTACK_STAND_PRIMARYFIRE] = ACT_HL2MP_GESTURE_RANGE_ATTACK_AR2
holdTypes.heavy[ACT_MP_ATTACK_CROUCH_PRIMARYFIRE] = ACT_HL2MP_GESTURE_RANGE_ATTACK_AR2

holdTypes.rpg[ACT_MP_RELOAD_STAND] = ACT_HL2MP_GESTURE_RELOAD_AR2

holdTypes.rpg_heavy = table.Copy(holdTypes.rpg)
holdTypes.rpg_heavy[ACT_MP_ATTACK_STAND_PRIMARYFIRE] = ACT_HL2MP_GESTURE_RANGE_ATTACK_CROSSBOW
holdTypes.rpg_heavy[ACT_MP_ATTACK_CROUCH_PRIMARYFIRE] = ACT_HL2MP_GESTURE_RANGE_ATTACK_CROSSBOW

holdTypes.sniper = table.Copy(holdTypes.rpg)
holdTypes.sniper[ACT_MP_ATTACK_STAND_PRIMARYFIRE] = ACT_HL2MP_GESTURE_RANGE_ATTACK_AR2
holdTypes.sniper[ACT_MP_ATTACK_CROUCH_PRIMARYFIRE] = ACT_HL2MP_GESTURE_RANGE_ATTACK_AR2
holdTypes.sniper[ACT_MP_RELOAD_STAND] = ACT_HL2MP_GESTURE_RELOAD_AR2
holdTypes.sniper[ACT_MP_RELOAD_CROUCH] = ACT_HL2MP_GESTURE_RELOAD_AR2

holdTypes.pistol_aimed = table.Copy(holdTypes.pistol)
holdTypes.pistol_aimed[ACT_MP_STAND_IDLE] = ACT_HL2MP_IDLE_REVOLVER
holdTypes.pistol_aimed[ACT_MP_WALK] = ACT_HL2MP_WALK_REVOLVER
